...
|근면|Progress_Sloth_Value|||
|면죄|Progress_Absolution_Value|||
...
- 데이터창의 왼쪽에는 해당 진행에서 속죄 수치가 가장 높은 캐릭터의 초상화가 나타나고, 그 옆에는 플레이어의 면죄 수치가 나타나 진행바로 나타나 있다.
...
- 하단에는 대사를 볼 수 있는 창이 있고, 이 대화창의 왼쪽 상단에는 말하고 있는 등장 인물의 이름이 뜬다.
